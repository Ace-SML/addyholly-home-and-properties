    ...
    >
      <div className="container mx-auto px-4 md:px-8 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <button className="text-[#1A2B4C] hover:text-amber-500 transition-colors">
            <Search size={20} />
          </button>
          <button className="text-[#1A2B4C] hover:text-amber-500 transition-colors">
            <Heart size={20} />
          ...
          <a href="#properties">
            <button
              href="#properties"
              className="bg-[#1A2B4C] text-white px-6 py-2 rounded-full font-bold text-sm uppercase tracking-wider hover:bg-slate-800 transition-all flex items-center gap-2 shadow-lg shadow-navy/10"
            >
        ...
        <div className="lg:hidden absolute top-full left-0 right-0 bg-white border-t p-6 shadow-xl animate-in slide-in-from-top">
          <nav className="flex flex-col gap-4">
            ...
            <div className="pt-4 border-t flex flex-col gap-4">
              <button className="bg-[#1A2B4C] text-white px-6 py-4 rounded-2xl font-black uppercase text-sm tracking-widest w-full">
                Login
              </button>
            </div>
          </nav>
