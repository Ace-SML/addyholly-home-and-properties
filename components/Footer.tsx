    ...
    <footer className="bg-slate-900 text-white pt-20 pb-10">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              {[Facebook, Twitter, Instagram, Linkedin].map((Icon, i) => (
                <a key={i} href="#" className="bg-slate-800 p-2.5 rounded-lg hover:bg-amber-500 transition-colors">
                  <Icon size={20} />
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400">
              <li><a href="#" className="hover:text-white transition-colors">Featured Properties</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Recent Sales</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Real Estate Investment</a></li>
          ...
          <div>
            <h4 className="text-lg font-bold mb-8 text-amber-400">Contact Us</h4>
            <ul className="space-y-6 text-slate-400">
              <li className="flex gap-4">
                <MapPin className="text-amber-500 shrink-0" size={20} />
                <span>123 Elite Plaza, Suite 400<br />Beverly Hills, CA 90210</span>
              </li>
              <li className="flex gap-4">
              ...
              <li className="flex gap-4">
                ...
                <span>contact@addyholly.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
          <p>© {new Date().getFullYear()} AddyHolly Homes & Properties. All rights reserved.</p>
